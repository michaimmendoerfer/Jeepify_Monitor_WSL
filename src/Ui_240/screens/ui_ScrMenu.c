...
void ui_ScrMenu_screen_init(void)
{
    ...
    lv_obj_set_y(ui_LblMenuVersion, lv_pct(7));
    ...
    lv_obj_set_style_text_font(ui_LblMenuBatt, &lv_font_montserrat_12, LV_PART_MAIN | LV_STATE_DEFAULT);
