...
void ui_ScrMenu_screen_init(void)
{
    ...
    ui_ImgBGMenu = lv_img_create(ui_ScrMenu);
    lv_img_set_src(ui_ImgBGMenu, &ui_img_jeepifybackground_png);
    lv_obj_set_width(ui_ImgBGMenu, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_ImgBGMenu, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_ImgBGMenu, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_ImgBGMenu, LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    lv_obj_clear_flag(ui_ImgBGMenu, LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                      LV_OBJ_FLAG_SCROLL_CHAIN);     /// Flags
    lv_obj_set_style_opa(ui_ImgBGMenu, 200, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_BtnMenu1, lv_pct(-25));
    lv_obj_set_y(ui_BtnMenu1, lv_pct(-25));
    ...
    lv_obj_set_x(ui_BtnMenu2, lv_pct(25));
    lv_obj_set_y(ui_BtnMenu2, lv_pct(-25));
    ...
    lv_obj_set_x(ui_BtnMenu3, lv_pct(-25));
    lv_obj_set_y(ui_BtnMenu3, lv_pct(25));
    ...
    lv_obj_set_x(ui_BtnMenu4, lv_pct(25));
    lv_obj_set_y(ui_BtnMenu4, lv_pct(25));
