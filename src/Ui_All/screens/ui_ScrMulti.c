...
void ui_ScrMulti_screen_init(void)
{
    ...
    ui_ImgBGMulti = lv_img_create(ui_ScrMulti);
    lv_img_set_src(ui_ImgBGMulti, &ui_img_jeepifybackground_png);
    lv_obj_set_width(ui_ImgBGMulti, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_ImgBGMulti, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_ImgBGMulti, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_ImgBGMulti, LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    lv_obj_clear_flag(ui_ImgBGMulti, LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                      LV_OBJ_FLAG_SCROLL_CHAIN);     /// Flags
    lv_obj_set_style_opa(ui_ImgBGMulti, 200, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_y(ui_LblMultiScreenName, lv_pct(-40));
    ...
    lv_obj_set_style_pad_top(ui_LblMultiScreenName, 3, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui_LblMultiScreenName, 3, LV_PART_MAIN | LV_STATE_DEFAULT);
