...
void ui_ScrPeriph_screen_init(void)
{
    ...
    ui_ImgBGPeriph = lv_img_create(ui_ScrPeriph);
    lv_img_set_src(ui_ImgBGPeriph, &ui_img_jeepifybackground_png);
    lv_obj_set_width(ui_ImgBGPeriph, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_ImgBGPeriph, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_ImgBGPeriph, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_ImgBGPeriph, LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    lv_obj_clear_flag(ui_ImgBGPeriph, LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                      LV_OBJ_FLAG_SCROLL_CHAIN);     /// Flags
    lv_obj_set_style_opa(ui_ImgBGPeriph, 200, LV_PART_MAIN | LV_STATE_DEFAULT);
