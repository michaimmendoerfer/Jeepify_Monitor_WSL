...
void ui_ScrVolt_screen_init(void)
{
    ...
    ui_ImgBGVolt = lv_img_create(ui_ScrVolt);
    lv_img_set_src(ui_ImgBGVolt, &ui_img_jeepifybackground_png);
    lv_obj_set_width(ui_ImgBGVolt, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_ImgBGVolt, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_ImgBGVolt, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_ImgBGVolt, LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    lv_obj_clear_flag(ui_ImgBGVolt, LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                      LV_OBJ_FLAG_SCROLL_CHAIN);     /// Flags
    lv_obj_set_style_opa(ui_ImgBGVolt, 200, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_LblVoltPeer, lv_pct(0));
    lv_obj_set_y(ui_LblVoltPeer, lv_pct(35));
