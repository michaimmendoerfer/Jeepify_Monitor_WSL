...
void Ui_Init_Custom(lv_event_t * e)
{
	...
	int  LEDCenterX = 0;
	int  LEDCenterY = SCREEN_RES_VER/2-SCREEN_RES_VER/18;
	...
	lv_obj_align(Ui_LedRcv, LV_ALIGN_CENTER, LEDCenterX, LEDCenterY);
	...
	lv_obj_align(Ui_LedSnd, LV_ALIGN_CENTER, LEDCenterX - 20, LEDCenterY - 3);
	...
	lv_obj_align(Ui_LedPair, LV_ALIGN_CENTER, LEDCenterX + 20, LEDCenterY - 3);
